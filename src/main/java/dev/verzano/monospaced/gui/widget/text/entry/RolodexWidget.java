...
public class RolodexWidget<T extends Stringable> extends TextWidget {
    ...
    private void printItem(T item, int y) {
        ...
        for (var i = 0; i < getContentHeight(); i++) {
            ...
            if (i == middleRow) {
                MonospacedGui.print(PrintUtils.getRowForText(item.stringify(), getTextPosition(), getSgrFormatPrefix(), getContentWidth()));
            } else {
